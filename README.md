...
#### 3.回答に従う
回答者の対話方法がGuideManのLINE BOTに表示される。

#### 4.回答者とチャットによって対話する場合
LINE BOTを介して対話する。（LINE BOTをお互いの会話をパイプする）
対話が終了次第、LINE BOTは対話終了ボタンを押す。

#### 4.実際に回答者と会う場合
回答者が自分に近くに来るのを待つ。近くに来たら、合図のためのポーズがLINE BOTに表示されます。待ち合わせが終わったら、待ち合わせ終了ボタンを押し、回答者と対話を開始する。
対話が終了次第、LINE BOTで、対話終了ボタンを押す。
